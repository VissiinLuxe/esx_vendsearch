...
DisableControls = function()
    DisableControlAction(0, 73) -- X 
    DisableControlAction(0, 323) -- X 
    DisableControlAction(0, 288) -- F1 
    DisableControlAction(0, 289) -- F2 
    DisableControlAction(0, 170) -- F3 
    DisableControlAction(0, 166) -- F5
    DisableControlAction(0, 167) -- F6 
end
